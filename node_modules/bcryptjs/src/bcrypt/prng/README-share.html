...
<html lang="zh-cn">
  ...
  <body>
    <div class="content markdown-body"><p>Because of <a href="https://github.com/dcodeIO/bcrypt.js/issues/16">reasonable security doubts</a>, these files, which used to be
a part of bcrypt-isaac.js, are no longer used but are kept here for reference only.</p>
<p>What is required instead is a proper way to collect entropy sources (using an intermediate stream cipher) which is then
used to seed the CSPRNG. Pick one and use <code>bcrypt.setRandomFallback</code> instead.</p>
</div>
  </body>
</html>
