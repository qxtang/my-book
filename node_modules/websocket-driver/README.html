...
<html lang="zh-cn">
  ...
  <body>
    ...
    <div class="content markdown-body"><h1>websocket-driver <a href="https://travis-ci.org/faye/websocket-driver-node"><img src="https://travis-ci.org/faye/websocket-driver-node.svg" alt="Build Status"></a></h1>
...
project.</p>
<h2>Installation</h2>
<pre><code>$ npm install websocket-driver
</code></pre>
<h2>Usage</h2>
...
<pre><code class="language-js">proxy.on('error', function(error) {
...
<pre><code class="language-js">proxy.setHeader('User-Agent', 'node');
proxy.start();
</code></pre>
<h3>Driver API</h3>
<p>Drivers are created using one of the following methods:</p>
<pre><code class="language-js">driver = websocket.http(request, options)
