...
<pre><code class="language-sh">$ npm install --save use
</code></pre>
...
<h2>Usage</h2>
<pre><code class="language-js">const use = require('use');
</code></pre>
