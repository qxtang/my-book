...
<html lang="zh-cn">
  ...
  <body>
    <div class="content markdown-body"><h1>PauseStream</h1>
<p>This is a <code>Stream</code> that will strictly buffer when paused.
Connect it to anything you need buffered.</p>
<pre><code class="language-js">  var ps = require('pause-stream')();
...
<p><code>PauseStream</code> will buffer whenever paused.
it will buffer when yau have called <code>pause</code> manually.
but also when it's downstream <code>dest.write()===false</code>.
it will attempt to drain the buffer when you call resume
or the downstream emits <code>'drain'</code></p>
<p><code>PauseStream</code> is tested using <a href="https://github.com/dominictarr/stream-spec">stream-spec</a>
and <a href="https://github.com/dominictarr/stream-tester">stream-tester</a></p>
<p>This is now the default case of
<a href="https://github.com/dominictarr/through">through</a></p>
<p>https://github.com/dominictarr/pause-stream/commit/4a6fe3dc2c11091b1efbfde912e0473719ed9cc0</p>
</div>
  </body>
</html>
