...
<pre><code class="language-sh">$ npm install --save repeat-element
</code></pre>
<h2>Usage</h2>
<pre><code class="language-js">const repeat = require('repeat-element');
