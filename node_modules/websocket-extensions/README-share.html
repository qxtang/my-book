...
<html lang="zh-cn">
  ...
  <body>
    <div class="content markdown-body"><h1>websocket-extensions <a href="http://travis-ci.org/faye/websocket-extensions-node"><img src="https://secure.travis-ci.org/faye/websocket-extensions-node.svg" alt="Build status"></a></h1>
...
<h2>Installation</h2>
<pre><code>$ npm install websocket-extensions
</code></pre>
<h2>Usage</h2>
...
<pre><code class="language-js">var Extensions = require('websocket-extensions'),
...
<pre><code class="language-js">request.headers['sec-websocket-extensions'] = exts.generateOffer();
</code></pre>
...
<pre><code class="language-js">exts.activate(response.headers['sec-websocket-extensions']);
</code></pre>
...
<pre><code class="language-js">var clientOffer = request.headers['sec-websocket-extensions'],
...
<pre><code class="language-js">exts.validFrameRsv(frame)
</code></pre>
...
call:</p>
<pre><code class="language-js">exts.processIncomingMessage(message, function(error, msg) {
...
<pre><code class="language-js">exts.processOutgoingMessage(message, function(error, msg) {
...
<pre><code class="language-js">exts.close(function() {})
</code></pre>
...
<pre><code class="language-js">ext.createClientSession()
</code></pre>
<p>This returns a <em>ClientSession</em>, whose interface is defined below.</p>
<pre><code class="language-js">ext.createServerSession(offers)
</code></pre>
...
offer header:</p>
<pre><code>Sec-WebSocket-Extensions: permessage-deflate; server_no_context_takeover; server_max_window_bits=8, \
                          permessage-deflate; server_max_window_bits=15
</code></pre>
<p>then the <code>permessage-deflate</code> extension will receive the call:</p>
<pre><code class="language-js">ext.createServerSession([
...
<pre><code class="language-js">clientSession.generateOffer()
// e.g.  -&gt; [
//            { server_no_context_takeover: true, server_max_window_bits: 8 },
//            { server_max_window_bits: 15 }
//          ]
...
<pre><code class="language-js">clientSession.activate(params) // -&gt; true
</code></pre>
...
<pre><code class="language-js">serverSession.generateResponse()
...
<pre><code class="language-js">session.processIncomingMessage(message, function(error, msg) { ... })
</code></pre>
...
<pre><code class="language-js">session.processOutgoingMessage(message, function(error, msg) { ... })
</code></pre>
...
<pre><code class="language-js">session.close()
</code></pre>
